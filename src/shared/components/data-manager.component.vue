  ...
  methods: {
    ...
    confirmDeleteSelected() {
      this.$confirm.require({
        ...
        rejectClassName: 'p-button-secondary p-button-outline',
        acceptLabel: 'Delete',
...
<template>
  ...
  <pv-column :exportable="false" style="min-width:8rem">
    <template #body="slotProps">
      <pv-button icon="pi pi-pencil" outline rounded class="mr-2" @click="editItem(slotProps.data)"/>
      <pv-button icon="pi pi-trash" outline rounded severity="danger" @click="confirmDeleteItem(slotProps.data)"/>
    </template>
  </pv-column>
  </pv-data-table>
